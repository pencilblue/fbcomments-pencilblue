...
FacebookComments.onStartup = function(cb) {
    pb.TemplateService.registerGlobal('fb_app_id', function(flag, cb) {
        pb.plugins.getSetting('facebook_app_id', 'fbcomments-pencilblue', function(err, facebookAppId) {
            cb(err, facebookAppId);
        });
    });
